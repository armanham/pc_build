...
import com.bdg.pc_build.product.model.dto.main.CaseDTO;
...
public class aCase extends Product {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "aCase")
    ...
    public boolean equals(Object o) {
        ...
        aCase aCase = (com.bdg.pc_build.product.model.entity.main.aCase) o;
